...
public class ResponseBoardDto {
    ...
    @Builder
    public ResponseBoardDto(String isComment, Long boardId, String title, String boardContent, LocalDateTime boardWriteDate, String boardWriter, String boardTitle, String category, List<ResponseReplyDto> reply, List<ResponseReportDto> report, BoardImage boardImage) {
