    ...
    <>
      ...
      <Section>
        ...
        <Intro>
            ...
            <IntroDescription>전 객실 서울의 환상적인 파노라믹뷰<br /> 예술적 품격을 갖춘 모던한 디럭스 객실부터 우아한 감성의<br /> 스위트 객실과 최고급 풀빌라까지,<br /> 다양한 객실에서 격이 다른 휴식과 여유를 경험해 보세요</IntroDescription>
            <Link to="/rooms">
              <DetailBtn>
                <p>자세히보기</p>
      ...
      <Section>
        <LeftIntro>
          ...
          <DiningDescription>최상급 식자재를 사용한 미슐랭 스타 레스토랑부터 프리미엄 뷔페까지<br /> 호텔 다이닝을 만나보세요.</DiningDescription>
          <Link to="/dining">
            <DetailBtn>
              <p>자세히보기</p>
              <DetailSvg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><title/><g data-name="Layer 2" id="Layer_2"><path d="M22,9a1,1,0,0,0,0,1.42l4.6,4.6H3.06a1,1,0,1,0,0,2H26.58L22,21.59A1,1,0,0,0,22,23a1,1,0,0,0,1.41,0l6.36-6.36a.88.88,0,0,0,0-1.27L23.42,9A1,1,0,0,0,22,9Z"/></g></DetailSvg>
      ...
      <Section>
        ...
        <Intro>
          ...
          <IntroDescription>자연이 주는 낭만 속의 이국적인 수영장과 다채로운 액티비티를 즐길 수 있는 엔터테인먼트 공간까지, 도심 속에서 여유로운 시간을 느껴보세요</IntroDescription>
          <DetailBtn>
            <p>자세히보기</p>
            <DetailSvg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><title/><g data-name="Layer 2" id="Layer_2"><path d="M22,9a1,1,0,0,0,0,1.42l4.6,4.6H3.06a1,1,0,1,0,0,2H26.58L22,21.59A1,1,0,0,0,22,23a1,1,0,0,0,1.41,0l6.36-6.36a.88.88,0,0,0,0-1.27L23.42,9A1,1,0,0,0,22,9Z"/></g></DetailSvg>
          </DetailBtn>
